...
class GPS_Procedures extends NavSystemElement {
    ...
    onUpdate(_deltaTime) {
//PM Modif: Unactivate "Activate Approach" element if not relevant
...
//PM Modif: End Unactivate "Activate Approach" element if not relevant
    }
    onExit() {
    }
    onEvent(_event) {
